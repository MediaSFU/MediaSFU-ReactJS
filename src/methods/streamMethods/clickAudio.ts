...
import { audioProcessingConstraints, applyAudioProcessing } from '../../consumers/audioProcessing';

export interface ClickAudioOptions {
  audioProcessing?: import('../../consumers/audioProcessing').AudioProcessingOptions;
