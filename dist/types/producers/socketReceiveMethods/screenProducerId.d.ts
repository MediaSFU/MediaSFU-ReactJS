 ...
 * ```
 */
export declare const screenProducerId: ({ producerId, screenId, membersReceived, shareScreenStarted, deferScreenReceived, participants, updateScreenId, updateShareScreenStarted, updateDeferScreenReceived, }: ScreenProducerIdOptions) => void;
//# sourceMappingURL=screenProducerId.d.ts.map