...
import { HeadlessParameters, ResolvedMedia, RoomReadiness } from './headlessTypes';
...
import { switchCamera, switchMicrophone, flipCamera } from './sessionControls';
import {
 ...
 * @example
 * ```tsx
 * import { MediasfuGeneric, PreJoinPage, AudioGrid, useMediasfuHeadless } from 'mediasfu-reactjs';
 *
 * function Call() {
